$('.add-btn').on('click', addSpellHandler) //Adds new text input and timer.
$('input').on('keyup', $(`#spells-input-${textInputId}`), searchHandler) //For search box suggestions.
$('#spell-suggestions').on('click', useSuggestion) //Update spell input with suggestion.
