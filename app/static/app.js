...
function addTimerHandler(e) {
    ...
    if (!inputVal) {
       ...
       inputBox.find('.timers-wrapper').append(newInput); 
        inputBox.find('.timers').attr('name', `${inputVal}-timers`) /**Change the previous inputs to the new spell for the 'name'.
